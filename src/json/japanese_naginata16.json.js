...
function manipulatorsA2() {
  return [
    {"description":"(シンクロ) 編集モード1左","type":"basic",
      "conditions":[{"type":"variable_unless","name":"shifted","value":1},
    ...
    {"description":"[あ, い] て → でぃ","type":"basic",
      "conditions":[{"type":"variable_if","name":"EM1L","value":1},
        {"type":"variable_unless","name":"shifted","value":1},
        {"input_sources":[{"language":"ja"}],"type":"input_source_if"},
      {"input_sources":[{"input_mode_id":"Roman$"}],"type":"input_source_unless"}],
      "from":{"key_code":"e"},
    ...
    {"description":"[な, ん] 小 → カッコ外し","type":"basic",
      "conditions":[{"type":"variable_if","name":"EM2L","value":1},
        {"type":"variable_unless","name":"shifted","value":1},
        {"input_sources":[{"language":"ja"}],"type":"input_source_if"},
      {"input_sources":[{"input_mode_id":"Roman$"}],"type":"input_source_unless"}],
      "from":{"key_code":"q"},
    ...
    {"description":"(日本語IM時)(JIS/US)[な, ん] き → +『』","type":"basic",
      "conditions":[{"type":"keyboard_type_if","keyboard_types":["jis"]},
        {"type":"variable_if","name":"EM2L","value":1},
        {"type":"variable_unless","name":"shifted","value":1},
        {"input_sources":[{"language":"ja"}],"type":"input_source_if"},
        {"input_sources":[{"input_source_id":"Kotoeri"}],"type":"input_source_if"},
      {"input_sources":[{"input_mode_id":"Roman$"}],"type":"input_source_unless"}],
      "from":{"key_code":"w"},
      "to":[{"set_variable":{"name":"EM2L","value":1}},
...
function manipulatorsB() {
  return [
    ...
    {"description":"[右半] (シンクロ) ひ, や → ぴゃ","type":"basic",
      "conditions":[{"type":"variable_if","name":"HL","value":1},
        {"type":"variable_unless","name":"shifted","value":1},
        {"input_sources":[{"language":"ja"}],"type":"input_source_if"},
      {"input_sources":[{"input_mode_id":"Roman$"}],"type":"input_source_unless"}],
      "from":{"simultaneous":[
    ...
    {"description":"[左濁] (シンクロ) う, あ → ヴぁ","type":"basic",
      "conditions":[{"type":"variable_if","name":"DR","value":1},
        {"type":"variable_unless","name":"shifted","value":1},
        {"input_sources":[{"language":"ja"}],"type":"input_source_if"},
      {"input_sources":[{"input_mode_id":"Roman$"}],"type":"input_source_unless"}],
      "from":{"simultaneous":[
    ...
    {"description":"[左半] (シンクロ) う, い → うぃ","type":"basic",
      "conditions":[{"type":"variable_if","name":"HR","value":1},
        {"type":"variable_unless","name":"shifted","value":1},
        {"input_sources":[{"language":"ja"}],"type":"input_source_if"},
      {"input_sources":[{"input_mode_id":"Roman$"}],"type":"input_source_unless"}],
      "from":{"simultaneous":[
    ...
    {"description":"[Sp] (シンクロ) 小, わ → (ゎ)","type":"basic",
      "conditions":[{"type":"variable_if","name":"shifted","value":1},
        {"input_sources":[{"language":"ja"}],"type":"input_source_if"},
      {"input_sources":[{"input_mode_id":"Roman$"}],"type":"input_source_unless"}],
      "from":{"simultaneous":[
        {"key_code":"q"},
    ...
    {"description":"(シンクロ) く, あ → IME ON","type":"basic",
      "conditions":[{"type":"variable_unless","name":"shifted","value":1}],
      "from":{"simultaneous":[
        {"key_code":"h"},
        {"key_code":"j"}
      ]},
      "to":[{"key_code":"lang1","repeat":false}
      ]
    },
    {"description":"(シンクロ) か, (っ) → IME OFF","type":"basic",
      "conditions":[{"type":"variable_unless","name":"shifted","value":1}],
      "from":{"simultaneous":[
        {"key_code":"f"},
        {"key_code":"g"}
      ]},
      "to":[{"key_code":"lang2","repeat":false}
      ]
    },
    ...
    {"description":"[あ, い] ろ → ……","type":"basic",
      "conditions":[{"type":"variable_if","name":"EM1L","value":1},
        {"type":"variable_unless","name":"shifted","value":1},
        {"input_sources":[{"language":"ja"}],"type":"input_source_if"},
      {"input_sources":[{"input_mode_id":"Roman$"}],"type":"input_source_unless"}],
      "from":{"key_code":"a"},
      "to":[{"key_code":"semicolon","modifiers":["option"]},{"key_code":"semicolon","modifiers":["option"]},{"key_code":"return_or_enter","repeat":false}
      ]
    },
    ...
    {"description":"(日本語IM時)(JIS/US)[あ, い] き → 『』","type":"basic",
      "conditions":[{"type":"keyboard_type_if","keyboard_types":["jis"]},
        {"type":"variable_if","name":"EM1L","value":1},
        {"type":"variable_unless","name":"shifted","value":1},
        {"input_sources":[{"language":"ja"}],"type":"input_source_if"},
        {"input_sources":[{"input_source_id":"Kotoeri"}],"type":"input_source_if"},
      {"input_sources":[{"input_mode_id":"Roman$"}],"type":"input_source_unless"}],
      "from":{"key_code":"w"},
      "to":[{"key_code":"close_bracket","modifiers":["shift"]},{"key_code":"non_us_pound","modifiers":["shift"]},{"key_code":"return_or_enter"},{"key_code":"b","modifiers":["control"],"repeat":false}
      ]
    },
    {"type":"basic",
      "conditions":[{"type":"variable_if","name":"EM1L","value":1},
      ...
      {"input_sources":[{"input_mode_id":"Roman$"}],"type":"input_source_unless"}],
      "from":{"key_code":"w"},
      "to":[{"key_code":"open_bracket","modifiers":["shift"]},{"key_code":"close_bracket","modifiers":["shift"]},{"key_code":"return_or_enter"},{"key_code":"b","modifiers":["control"],"repeat":false}
      ]
    },
    ...
    {"description":"(JIS/US)[あ, い] け → （）","type":"basic",
      "conditions":[{"type":"keyboard_type_if","keyboard_types":["jis"]},
        {"type":"variable_if","name":"EM1L","value":1},
        {"type":"variable_unless","name":"shifted","value":1},
        {"input_sources":[{"language":"ja"}],"type":"input_source_if"},
      {"input_sources":[{"input_mode_id":"Roman$"}],"type":"input_source_unless"}],
      "from":{"key_code":"s"},
      "to":[{"key_code":"8","modifiers":["shift"]},{"key_code":"9","modifiers":["shift"]},{"key_code":"return_or_enter"},{"key_code":"b","modifiers":["control"],"repeat":false}
      ]
    },
    {"type":"basic",
      "conditions":[{"type":"variable_if","name":"EM1L","value":1},
      ...
      {"input_sources":[{"input_mode_id":"Roman$"}],"type":"input_source_unless"}],
      "from":{"key_code":"s"},
      "to":[{"key_code":"9","modifiers":["shift"]},{"key_code":"0","modifiers":["shift"]},{"key_code":"return_or_enter"},{"key_code":"b","modifiers":["control"],"repeat":false}
      ]
    },
    {"description":"(日本語IM時)(JIS/US)[あ, い] ひ → 【】","type":"basic",
      "conditions":[{"type":"keyboard_type_if","keyboard_types":["jis"]},
        {"type":"variable_if","name":"EM1L","value":1},
        {"type":"variable_unless","name":"shifted","value":1},
        {"input_sources":[{"language":"ja"}],"type":"input_source_if"},
      ...
      {"input_sources":[{"input_mode_id":"Roman$"}],"type":"input_source_unless"}],
      "from":{"key_code":"x"},
      "to":[{"key_code":"8","modifiers":["option"]},{"key_code":"9","modifiers":["option"]},{"key_code":"return_or_enter"},{"key_code":"b","modifiers":["control"],"repeat":false}
      ]
    },
    {"type":"basic",
      "conditions":[{"type":"variable_if","name":"EM1L","value":1},
      ...
      {"input_sources":[{"input_mode_id":"Roman$"}],"type":"input_source_unless"}],
      "from":{"key_code":"x"},
      "to":[{"key_code":"9","modifiers":["option"]},{"key_code":"0","modifiers":["option"]},{"key_code":"return_or_enter"},{"key_code":"b","modifiers":["control"],"repeat":false}
      ]
    },
    ...
    {"description":"[あ, い] と → ？","type":"basic",
      "conditions":[{"type":"variable_if","name":"EM1L","value":1},
        {"type":"variable_unless","name":"shifted","value":1},
        {"input_sources":[{"language":"ja"}],"type":"input_source_if"},
      {"input_sources":[{"input_mode_id":"Roman$"}],"type":"input_source_unless"}],
      "from":{"key_code":"d"},
      "to":[{"key_code":"slash","modifiers":["shift"]},{"key_code":"return_or_enter","repeat":false}
      ]
    },
    {"description":"[あ, い] は → ！","type":"basic",
      "conditions":[{"type":"variable_if","name":"EM1L","value":1},
        {"type":"variable_unless","name":"shifted","value":1},
        {"input_sources":[{"language":"ja"}],"type":"input_source_if"},
      {"input_sources":[{"input_mode_id":"Roman$"}],"type":"input_source_unless"}],
      "from":{"key_code":"c"},
      "to":[{"key_code":"1","modifiers":["shift"]},{"key_code":"return_or_enter","repeat":false}
      ]
    },
    {"description":"[あ, い] し → 保","type":"basic",
      "conditions":[{"type":"variable_if","name":"EM1L","value":1},
        {"type":"variable_unless","name":"shifted","value":1},
        {"input_sources":[{"language":"ja"}],"type":"input_source_if"},
      {"input_sources":[{"input_mode_id":"Roman$"}],"type":"input_source_unless"}],
      "from":{"key_code":"r"},
      "to":[{"key_code":"s","modifiers":["command"],"repeat":false}
      ]
    },
    {"description":"(JIS/US)[あ, い] か → 「」","type":"basic",
      "conditions":[{"type":"keyboard_type_if","keyboard_types":["jis"]},
        {"type":"variable_if","name":"EM1L","value":1},
        {"type":"variable_unless","name":"shifted","value":1},
        {"input_sources":[{"language":"ja"}],"type":"input_source_if"},
      {"input_sources":[{"input_mode_id":"Roman$"}],"type":"input_source_unless"}],
      "from":{"key_code":"f"},
      "to":[{"key_code":"close_bracket"},{"key_code":"non_us_pound"},{"key_code":"return_or_enter"},{"key_code":"b","modifiers":["control"],"repeat":false}
      ]
    },
    {"type":"basic",
      "conditions":[{"type":"variable_if","name":"EM1L","value":1},
      ...
      {"input_sources":[{"input_mode_id":"Roman$"}],"type":"input_source_unless"}],
      "from":{"key_code":"f"},
      "to":[{"key_code":"open_bracket"},{"key_code":"close_bracket"},{"key_code":"return_or_enter"},{"key_code":"b","modifiers":["control"],"repeat":false}
      ]
    },
    ...
    {"description":"[あ, い] 左 → ・未確定","type":"basic",
      "conditions":[{"type":"variable_if","name":"EM1L","value":1},
        {"type":"variable_unless","name":"shifted","value":1},
        {"input_sources":[{"language":"ja"}],"type":"input_source_if"},
      {"input_sources":[{"input_mode_id":"Roman$"}],"type":"input_source_unless"}],
    ...
    {"description":"[と, か] 右 → Home","type":"basic",
      "conditions":[{"type":"variable_if","name":"EM1R","value":1},
        {"type":"variable_unless","name":"shifted","value":1},
        {"input_sources":[{"language":"ja"}],"type":"input_source_if"},
      {"input_sources":[{"input_mode_id":"Roman$"}],"type":"input_source_unless"}],
      "from":{"key_code":"y"},
      "to":[{"key_code":"a","modifiers":["control"],"repeat":false}
      ]
    },
    ...
    {"description":"[と, か] た → End","type":"basic",
      "conditions":[{"type":"variable_if","name":"EM1R","value":1},
        {"type":"variable_unless","name":"shifted","value":1},
        {"input_sources":[{"language":"ja"}],"type":"input_source_if"},
      {"input_sources":[{"input_mode_id":"Roman$"}],"type":"input_source_unless"}],
      "from":{"key_code":"n"},
      "to":[{"key_code":"e","modifiers":["control"],"repeat":false}
      ]
    },
    {"description":"[と, か] BS → 文末消去","type":"basic",
      "conditions":[{"type":"variable_if","name":"EM1R","value":1},
        {"type":"variable_unless","name":"shifted","value":1},
        {"input_sources":[{"language":"ja"}],"type":"input_source_if"},
      {"input_sources":[{"input_mode_id":"Roman$"}],"type":"input_source_unless"}],
      "from":{"key_code":"u"},
      "to":[{"key_code":"k","modifiers":["control"],"repeat":false}
      ]
    },
    {"description":"[と, か] あ → ↑","type":"basic",
      "conditions":[{"type":"variable_if","name":"EM1R","value":1},
        {"type":"variable_unless","name":"shifted","value":1},
        {"input_sources":[{"language":"ja"}],"type":"input_source_if"},
      {"input_sources":[{"input_mode_id":"Roman$"}],"type":"input_source_unless"}],
    ...
    {"description":"[と, か] る → 再","type":"basic",
      "conditions":[{"type":"variable_if","name":"EM1R","value":1},
        {"type":"variable_unless","name":"shifted","value":1},
        {"input_sources":[{"language":"ja"}],"type":"input_source_if"},
      {"input_sources":[{"input_mode_id":"Roman$"}],"type":"input_source_unless"}],
      "from":{"key_code":"i"},
      "to":[{"key_code":"lang1"},{"key_code":"lang1","repeat":false}
      ]
    },
    {"description":"[と, か] い → +↑","type":"basic",
      "conditions":[{"type":"variable_if","name":"EM1R","value":1},
        {"type":"variable_unless","name":"shifted","value":1},
        {"input_sources":[{"language":"ja"}],"type":"input_source_if"},
      {"input_sources":[{"input_mode_id":"Roman$"}],"type":"input_source_unless"}],
    ...
    {"description":"[と, か] す → Del","type":"basic",
      "conditions":[{"type":"variable_if","name":"EM1R","value":1},
        {"type":"variable_unless","name":"shifted","value":1},
        {"input_sources":[{"language":"ja"}],"type":"input_source_if"},
      {"input_sources":[{"input_mode_id":"Roman$"}],"type":"input_source_unless"}],
    ...
    {"description":"[と, か] ら → +7↓","type":"basic",
      "conditions":[{"type":"variable_if","name":"EM1R","value":1},
        {"type":"variable_unless","name":"shifted","value":1},
        {"input_sources":[{"language":"ja"}],"type":"input_source_if"},
      {"input_sources":[{"input_mode_id":"Roman$"}],"type":"input_source_unless"}],
    ...
    {"description":"[と, か] へ → 入力キャンセル","type":"basic",
      "conditions":[{"type":"variable_if","name":"EM1R","value":1},
        {"type":"variable_unless","name":"shifted","value":1},
        {"input_sources":[{"language":"ja"}],"type":"input_source_if"},
      {"input_sources":[{"input_mode_id":"Roman$"}],"type":"input_source_unless"}],
      "from":{"key_code":"p"},
      "to":[{"key_code":"escape"},{"key_code":"escape"},{"key_code":"escape","repeat":false}
      ]
    },
    {"description":"[と, か] ー → カタカナ変換","type":"basic",
      "conditions":[{"type":"variable_if","name":"EM1R","value":1},
        {"type":"variable_unless","name":"shifted","value":1},
        {"input_sources":[{"language":"ja"}],"type":"input_source_if"},
      {"input_sources":[{"input_mode_id":"Roman$"}],"type":"input_source_unless"}],
      "from":{"key_code":"semicolon"},
      "to":[{"key_code":"f7","repeat":false}
      ]
    },
    {"description":"[と, か] れ → ひらがな変換","type":"basic",
      "conditions":[{"type":"variable_if","name":"EM1R","value":1},
        {"type":"variable_unless","name":"shifted","value":1},
        {"input_sources":[{"language":"ja"}],"type":"input_source_if"},
      {"input_sources":[{"input_mode_id":"Roman$"}],"type":"input_source_unless"}],
      "from":{"key_code":"slash"},
      "to":[{"key_code":"f6","repeat":false}
      ]
    },
    ...
    {"description":"[な, ん] て → 行頭□□□挿入","type":"basic",
      "conditions":[{"type":"variable_if","name":"EM2L","value":1},
        {"type":"variable_unless","name":"shifted","value":1},
        {"input_sources":[{"language":"ja"}],"type":"input_source_if"},
      {"input_sources":[{"input_mode_id":"Roman$"}],"type":"input_source_unless"}],
      "from":{"key_code":"e"},
      "to":[{"key_code":"a","modifiers":["control"]},{"key_code":"return_or_enter"},{"key_code":"spacebar"},{"key_code":"spacebar"},{"key_code":"spacebar"},{"key_code":"e","modifiers":["control"],"repeat":false}
      ]
    },
    {"description":"[な, ん] と → □□□","type":"basic",
      "conditions":[{"type":"variable_if","name":"EM2L","value":1},
        {"type":"variable_unless","name":"shifted","value":1},
        {"input_sources":[{"language":"ja"}],"type":"input_source_if"},
      {"input_sources":[{"input_mode_id":"Roman$"}],"type":"input_source_unless"}],
      "from":{"key_code":"d"},
      "to":[{"key_code":"spacebar"},{"key_code":"spacebar"},{"key_code":"spacebar","repeat":false}
      ]
    },
    {"description":"[な, ん] は → 行頭□□□戻し","type":"basic",
      "conditions":[{"type":"variable_if","name":"EM2L","value":1},
        {"type":"variable_unless","name":"shifted","value":1},
        {"input_sources":[{"language":"ja"}],"type":"input_source_if"},
      {"input_sources":[{"input_mode_id":"Roman$"}],"type":"input_source_unless"}],
      "from":{"key_code":"c"},
      "to":[{"key_code":"a","modifiers":["control"]},{"key_code":"delete_or_backspace"},{"key_code":"delete_forward"},{"key_code":"delete_forward"},{"key_code":"delete_forward"},{"key_code":"e","modifiers":["control"],"repeat":false}
      ]
    },
    {"description":"[な, ん] し → 行頭□挿入","type":"basic",
      "conditions":[{"type":"variable_if","name":"EM2L","value":1},
        {"type":"variable_unless","name":"shifted","value":1},
        {"input_sources":[{"language":"ja"}],"type":"input_source_if"},
      {"input_sources":[{"input_mode_id":"Roman$"}],"type":"input_source_unless"}],
      "from":{"key_code":"r"},
      "to":[{"key_code":"a","modifiers":["control"]},{"key_code":"return_or_enter"},{"key_code":"spacebar"},{"key_code":"e","modifiers":["control"],"repeat":false}
      ]
    },
    {"description":"[な, ん] こ → 行頭□戻し","type":"basic",
      "conditions":[{"type":"variable_if","name":"EM2L","value":1},
        {"type":"variable_unless","name":"shifted","value":1},
        {"input_sources":[{"language":"ja"}],"type":"input_source_if"},
      {"input_sources":[{"input_mode_id":"Roman$"}],"type":"input_source_unless"}],
      "from":{"key_code":"v"},
      "to":[{"key_code":"a","modifiers":["control"]},{"key_code":"delete_or_backspace"},{"key_code":"delete_forward"},{"key_code":"e","modifiers":["control"],"repeat":false}
      ]
    },
    ...
    {"description":"[な, ん] (っ) → ／","type":"basic",
      "conditions":[{"type":"variable_if","name":"EM2L","value":1},
        {"type":"variable_unless","name":"shifted","value":1},
        {"input_sources":[{"language":"ja"}],"type":"input_source_if"},
      {"input_sources":[{"input_mode_id":"Roman$"}],"type":"input_source_unless"}],
      "from":{"key_code":"g"},
      "to":[{"key_code":"slash","modifiers":["option"]},{"key_code":"return_or_enter","repeat":false}
      ]
    },
    ...
    {"description":"[は, こ] 右 → +Home","type":"basic",
      "conditions":[{"type":"variable_if","name":"EM2R","value":1},
        {"type":"variable_unless","name":"shifted","value":1},
        {"input_sources":[{"language":"ja"}],"type":"input_source_if"},
      {"input_sources":[{"input_mode_id":"Roman$"}],"type":"input_source_unless"}],
      "from":{"key_code":"y"},
      "to":[{"key_code":"a","modifiers":["shift","control"],"repeat":false}
      ]
    },
    {"description":"[は, こ] く → Copy","type":"basic",
      "conditions":[{"type":"variable_if","name":"EM2R","value":1},
        {"type":"variable_unless","name":"shifted","value":1},
        {"input_sources":[{"language":"ja"}],"type":"input_source_if"},
      {"input_sources":[{"input_mode_id":"Roman$"}],"type":"input_source_unless"}],
      "from":{"key_code":"h"},
      "to":[{"key_code":"c","modifiers":["command"],"repeat":false}
      ]
    },
    {"description":"[は, こ] た → +End","type":"basic",
      "conditions":[{"type":"variable_if","name":"EM2R","value":1},
        {"type":"variable_unless","name":"shifted","value":1},
        {"input_sources":[{"language":"ja"}],"type":"input_source_if"},
      {"input_sources":[{"input_mode_id":"Roman$"}],"type":"input_source_unless"}],
      "from":{"key_code":"n"},
      "to":[{"key_code":"e","modifiers":["shift","control"],"repeat":false}
      ]
    },
    {"description":"[は, こ] BS → Cut","type":"basic",
      "conditions":[{"type":"variable_if","name":"EM2R","value":1},
        {"type":"variable_unless","name":"shifted","value":1},
        {"input_sources":[{"language":"ja"}],"type":"input_source_if"},
      {"input_sources":[{"input_mode_id":"Roman$"}],"type":"input_source_unless"}],
      "from":{"key_code":"u"},
      "to":[{"key_code":"x","modifiers":["command"],"repeat":false}
      ]
    },
    {"description":"[は, こ] あ → →5","type":"basic",
      "conditions":[{"type":"variable_if","name":"EM2R","value":1},
        {"type":"variable_unless","name":"shifted","value":1},
        {"input_sources":[{"language":"ja"}],"type":"input_source_if"},
      {"input_sources":[{"input_mode_id":"Roman$"}],"type":"input_source_unless"}],
      "from":{"key_code":"j"},
      "to":[{"key_code":"p","modifiers":["control"]},{"key_code":"p","modifiers":["control"]},{"key_code":"p","modifiers":["control"]},{"key_code":"p","modifiers":["control"]},{"key_code":"p","modifiers":["control"]}
      ]
    },
    {"description":"[は, こ] な → ←5","type":"basic",
      "conditions":[{"type":"variable_if","name":"EM2R","value":1},
        {"type":"variable_unless","name":"shifted","value":1},
        {"input_sources":[{"language":"ja"}],"type":"input_source_if"},
      {"input_sources":[{"input_mode_id":"Roman$"}],"type":"input_source_unless"}],
      "from":{"key_code":"m"},
      "to":[{"key_code":"n","modifiers":["control"]},{"key_code":"n","modifiers":["control"]},{"key_code":"n","modifiers":["control"]},{"key_code":"n","modifiers":["control"]},{"key_code":"n","modifiers":["control"]}
      ]
    },
    {"description":"[は, こ] る → Paste","type":"basic",
      "conditions":[{"type":"variable_if","name":"EM2R","value":1},
        {"type":"variable_unless","name":"shifted","value":1},
        {"input_sources":[{"language":"ja"}],"type":"input_source_if"},
      {"input_sources":[{"input_mode_id":"Roman$"}],"type":"input_source_unless"}],
      "from":{"key_code":"i"},
      "to":[{"key_code":"v","modifiers":["command"],"repeat":false}
      ]
    },
    {"description":"[は, こ] い → +→5","type":"basic",
      "conditions":[{"type":"variable_if","name":"EM2R","value":1},
        {"type":"variable_unless","name":"shifted","value":1},
        {"input_sources":[{"language":"ja"}],"type":"input_source_if"},
      {"input_sources":[{"input_mode_id":"Roman$"}],"type":"input_source_unless"}],
      "from":{"key_code":"k"},
      "to":[{"key_code":"p","modifiers":["shift","control"]},{"key_code":"p","modifiers":["shift","control"]},{"key_code":"p","modifiers":["shift","control"]},{"key_code":"p","modifiers":["shift","control"]},{"key_code":"p","modifiers":["shift","control"]}
      ]
    },
    {"description":"[は, こ] ん → +←5","type":"basic",
      "conditions":[{"type":"variable_if","name":"EM2R","value":1},
        {"type":"variable_unless","name":"shifted","value":1},
        {"input_sources":[{"language":"ja"}],"type":"input_source_if"},
      {"input_sources":[{"input_mode_id":"Roman$"}],"type":"input_source_unless"}],
      "from":{"key_code":"comma"},
      "to":[{"key_code":"n","modifiers":["shift","control"]},{"key_code":"n","modifiers":["shift","control"]},{"key_code":"n","modifiers":["shift","control"]},{"key_code":"n","modifiers":["shift","control"]},{"key_code":"n","modifiers":["shift","control"]}
      ]
    },
    {"description":"[は, こ] す → Redo","type":"basic",
      "conditions":[{"type":"variable_if","name":"EM2R","value":1},
        {"type":"variable_unless","name":"shifted","value":1},
        {"input_sources":[{"language":"ja"}],"type":"input_source_if"},
      {"input_sources":[{"input_mode_id":"Roman$"}],"type":"input_source_unless"}],
      "from":{"key_code":"o"},
      "to":[{"key_code":"z","modifiers":["shift","command"],"repeat":false}
      ]
    },
    {"description":"[は, こ] う → +→20","type":"basic",
      "conditions":[{"type":"variable_if","name":"EM2R","value":1},
        {"type":"variable_unless","name":"shifted","value":1},
        {"input_sources":[{"language":"ja"}],"type":"input_source_if"},
      {"input_sources":[{"input_mode_id":"Roman$"}],"type":"input_source_unless"}],
      "from":{"key_code":"l"},
      "to":[{"key_code":"p","modifiers":["shift","control"]},{"key_code":"p","modifiers":["shift","control"]},{"key_code":"p","modifiers":["shift","control"]},{"key_code":"p","modifiers":["shift","control"]},{"key_code":"p","modifiers":["shift","control"]},{"key_code":"p","modifiers":["shift","control"]},{"key_code":"p","modifiers":["shift","control"]},{"key_code":"p","modifiers":["shift","control"]},{"key_code":"p","modifiers":["shift","control"]},{"key_code":"p","modifiers":["shift","control"]},{"key_code":"p","modifiers":["shift","control"]},{"key_code":"p","modifiers":["shift","control"]},{"key_code":"p","modifiers":["shift","control"]},{"key_code":"p","modifiers":["shift","control"]},{"key_code":"p","modifiers":["shift","control"]},{"key_code":"p","modifiers":["shift","control"]},{"key_code":"p","modifiers":["shift","control"]},{"key_code":"p","modifiers":["shift","control"]},{"key_code":"p","modifiers":["shift","control"]},{"key_code":"p","modifiers":["shift","control"]}
      ]
    },
    {"description":"[は, こ] ら → +←20","type":"basic",
      "conditions":[{"type":"variable_if","name":"EM2R","value":1},
        {"type":"variable_unless","name":"shifted","value":1},
        {"input_sources":[{"language":"ja"}],"type":"input_source_if"},
      {"input_sources":[{"input_mode_id":"Roman$"}],"type":"input_source_unless"}],
      "from":{"key_code":"period"},
      "to":[{"key_code":"n","modifiers":["shift","control"]},{"key_code":"n","modifiers":["shift","control"]},{"key_code":"n","modifiers":["shift","control"]},{"key_code":"n","modifiers":["shift","control"]},{"key_code":"n","modifiers":["shift","control"]},{"key_code":"n","modifiers":["shift","control"]},{"key_code":"n","modifiers":["shift","control"]},{"key_code":"n","modifiers":["shift","control"]},{"key_code":"n","modifiers":["shift","control"]},{"key_code":"n","modifiers":["shift","control"]},{"key_code":"n","modifiers":["shift","control"]},{"key_code":"n","modifiers":["shift","control"]},{"key_code":"n","modifiers":["shift","control"]},{"key_code":"n","modifiers":["shift","control"]},{"key_code":"n","modifiers":["shift","control"]},{"key_code":"n","modifiers":["shift","control"]},{"key_code":"n","modifiers":["shift","control"]},{"key_code":"n","modifiers":["shift","control"]},{"key_code":"n","modifiers":["shift","control"]},{"key_code":"n","modifiers":["shift","control"]}
      ]
    },
    {"description":"[は, こ] へ → Undo","type":"basic",
      "conditions":[{"type":"variable_if","name":"EM2R","value":1},
        {"type":"variable_unless","name":"shifted","value":1},
        {"input_sources":[{"language":"ja"}],"type":"input_source_if"},
      {"input_sources":[{"input_mode_id":"Roman$"}],"type":"input_source_unless"}],
      "from":{"key_code":"p"},
      "to":[{"key_code":"z","modifiers":["command"],"repeat":false}
      ]
    },
    {"description":"[は, こ] ー → 一行前選択","type":"basic",
      "conditions":[{"type":"variable_if","name":"EM2R","value":1},
        {"type":"variable_unless","name":"shifted","value":1},
        {"input_sources":[{"language":"ja"}],"type":"input_source_if"},
      {"input_sources":[{"input_mode_id":"Roman$"}],"type":"input_source_unless"}],
    ...
    {"description":"[は, こ] れ → 一行後選択","type":"basic",
      "conditions":[{"type":"variable_if","name":"EM2R","value":1},
        {"type":"variable_unless","name":"shifted","value":1},
        {"input_sources":[{"language":"ja"}],"type":"input_source_if"},
      {"input_sources":[{"input_mode_id":"Roman$"}],"type":"input_source_unless"}],
    ...
    {"description":"[左濁] さ → ざ","type":"basic",
      "conditions":[{"type":"variable_if","name":"DR","value":1},
        {"type":"variable_unless","name":"shifted","value":1},
        {"input_sources":[{"language":"ja"}],"type":"input_source_if"},
      {"input_sources":[{"input_mode_id":"Roman$"}],"type":"input_source_unless"}],
      "from":{"key_code":"u"},
      "to":[{"key_code":"z"},{"key_code":"a","repeat":false}
      ]
    },
    {"description":"[左濁] す → ず","type":"basic",
      "conditions":[{"type":"variable_if","name":"DR","value":1},
        {"type":"variable_unless","name":"shifted","value":1},
        {"input_sources":[{"language":"ja"}],"type":"input_source_if"},
      {"input_sources":[{"input_mode_id":"Roman$"}],"type":"input_source_unless"}],
      "from":{"key_code":"o"},
      "to":[{"key_code":"z"},{"key_code":"u","repeat":false}
      ]
    },
    {"description":"[左濁] く → ぐ","type":"basic",
      "conditions":[{"type":"variable_if","name":"DR","value":1},
        {"type":"variable_unless","name":"shifted","value":1},
        {"input_sources":[{"language":"ja"}],"type":"input_source_if"},
      {"input_sources":[{"input_mode_id":"Roman$"}],"type":"input_source_unless"}],
      "from":{"key_code":"h"},
      "to":[{"key_code":"g"},{"key_code":"u","repeat":false}
      ]
    },
    {"description":"[左濁] ふ → ぶ","type":"basic",
      "conditions":[{"type":"variable_if","name":"DR","value":1},
        {"type":"variable_unless","name":"shifted","value":1},
        {"input_sources":[{"language":"ja"}],"type":"input_source_if"},
      {"input_sources":[{"input_mode_id":"Roman$"}],"type":"input_source_unless"}],
      "from":{"key_code":"semicolon"},
      "to":[{"key_code":"b"},{"key_code":"u","repeat":false}
      ]
    },
    {"description":"[左半濁] ふ → ぷ","type":"basic",
      "conditions":[{"type":"variable_if","name":"DR","value":1},
        {"type":"variable_unless","name":"shifted","value":1},
        {"input_sources":[{"language":"ja"}],"type":"input_source_if"},
      {"input_sources":[{"input_mode_id":"Roman$"}],"type":"input_source_unless"}],
      "from":{"key_code":"semicolon"},
      "to":[{"key_code":"p"},{"key_code":"u","repeat":false}
      ]
    },
    {"description":"[左濁] た → だ","type":"basic",
      "conditions":[{"type":"variable_if","name":"DR","value":1},
        {"type":"variable_unless","name":"shifted","value":1},
        {"input_sources":[{"language":"ja"}],"type":"input_source_if"},
      {"input_sources":[{"input_mode_id":"Roman$"}],"type":"input_source_unless"}],
      "from":{"key_code":"n"},
      "to":[{"key_code":"d"},{"key_code":"a","repeat":false}
      ]
    },
    {"description":"[左濁] つ → づ","type":"basic",
      "conditions":[{"type":"variable_if","name":"DR","value":1},
        {"type":"variable_unless","name":"shifted","value":1},
        {"input_sources":[{"language":"ja"}],"type":"input_source_if"},
      {"input_sources":[{"input_mode_id":"Roman$"}],"type":"input_source_unless"}],
      "from":{"key_code":"l"},
      "to":[{"key_code":"d"},{"key_code":"u","repeat":false}
      ]
    },
    {"description":"[左濁] へ → べ","type":"basic",
      "conditions":[{"type":"variable_if","name":"DR","value":1},
        {"type":"variable_unless","name":"shifted","value":1},
        {"input_sources":[{"language":"ja"}],"type":"input_source_if"},
      {"input_sources":[{"input_mode_id":"Roman$"}],"type":"input_source_unless"}],
      "from":{"key_code":"p"},
      "to":[{"key_code":"b"},{"key_code":"e","repeat":false}
      ]
    },
    {"description":"[左濁] あ → が","type":"basic",
      "conditions":[{"type":"variable_if","name":"DR","value":1},
        {"type":"variable_unless","name":"shifted","value":1},
        {"input_sources":[{"language":"ja"}],"type":"input_source_if"},
      {"input_sources":[{"input_mode_id":"Roman$"}],"type":"input_source_unless"}],
      "from":{"key_code":"j"},
      "to":[{"key_code":"g"},{"key_code":"a","repeat":false}
      ]
    },
    {"description":"[右濁] け → げ","type":"basic",
      "conditions":[{"type":"variable_if","name":"DL","value":1},
        {"type":"variable_unless","name":"shifted","value":1},
        {"input_sources":[{"language":"ja"}],"type":"input_source_if"},
      {"input_sources":[{"input_mode_id":"Roman$"}],"type":"input_source_unless"}],
      "from":{"key_code":"s"},
      "to":[{"key_code":"g"},{"key_code":"e","repeat":false}
      ]
    },
    {"description":"[右濁] て → で","type":"basic",
      "conditions":[{"type":"variable_if","name":"DL","value":1},
        {"type":"variable_unless","name":"shifted","value":1},
        {"input_sources":[{"language":"ja"}],"type":"input_source_if"},
      {"input_sources":[{"input_mode_id":"Roman$"}],"type":"input_source_unless"}],
    ...
    {"description":"[右濁] し → じ","type":"basic",
      "conditions":[{"type":"variable_if","name":"DL","value":1},
        {"type":"variable_unless","name":"shifted","value":1},
        {"input_sources":[{"language":"ja"}],"type":"input_source_if"},
      {"input_sources":[{"input_mode_id":"Roman$"}],"type":"input_source_unless"}],
      "from":{"key_code":"r"},
      "to":[{"key_code":"z"},{"key_code":"i","repeat":false}
      ]
    },
    {"description":"[右濁] せ → ぜ","type":"basic",
      "conditions":[{"type":"variable_if","name":"DL","value":1},
        {"type":"variable_unless","name":"shifted","value":1},
        {"input_sources":[{"language":"ja"}],"type":"input_source_if"},
      {"input_sources":[{"input_mode_id":"Roman$"}],"type":"input_source_unless"}],
      "from":{"key_code":"a"},
      "to":[{"key_code":"z"},{"key_code":"e","repeat":false}
      ]
    },
    {"description":"[右濁] き → ぎ","type":"basic",
      "conditions":[{"type":"variable_if","name":"DL","value":1},
        {"type":"variable_unless","name":"shifted","value":1},
        {"input_sources":[{"language":"ja"}],"type":"input_source_if"},
      {"input_sources":[{"input_mode_id":"Roman$"}],"type":"input_source_unless"}],
      "from":{"key_code":"w"},
      "to":[{"key_code":"g"},{"key_code":"i","repeat":false}
      ]
    },
    {"description":"[右濁] と → ど","type":"basic",
      "conditions":[{"type":"variable_if","name":"DL","value":1},
        {"type":"variable_unless","name":"shifted","value":1},
        {"input_sources":[{"language":"ja"}],"type":"input_source_if"},
      {"input_sources":[{"input_mode_id":"Roman$"}],"type":"input_source_unless"}],
      "from":{"key_code":"d"},
      "to":[{"key_code":"d"},{"key_code":"o","repeat":false}
      ]
    },
    {"description":"[右濁] か → が","type":"basic",
      "conditions":[{"type":"variable_if","name":"DL","value":1},
        {"type":"variable_unless","name":"shifted","value":1},
        {"input_sources":[{"language":"ja"}],"type":"input_source_if"},
      {"input_sources":[{"input_mode_id":"Roman$"}],"type":"input_source_unless"}],
    ...
    {"description":"[右濁] ち → ぢ","type":"basic",
      "conditions":[{"type":"variable_if","name":"DL","value":1},
        {"type":"variable_unless","name":"shifted","value":1},
        {"input_sources":[{"language":"ja"}],"type":"input_source_if"},
      {"input_sources":[{"input_mode_id":"Roman$"}],"type":"input_source_unless"}],
      "from":{"key_code":"g"},
      "to":[{"key_code":"d"},{"key_code":"i","repeat":false}
      ]
    },
    {"description":"[右濁] ほ → ぼ","type":"basic",
      "conditions":[{"type":"variable_if","name":"DL","value":1},
        {"type":"variable_unless","name":"shifted","value":1},
        {"input_sources":[{"language":"ja"}],"type":"input_source_if"},
      {"input_sources":[{"input_mode_id":"Roman$"}],"type":"input_source_unless"}],
      "from":{"key_code":"z"},
      "to":[{"key_code":"b"},{"key_code":"o","repeat":false}
      ]
    },
    {"description":"[右濁] ひ → び","type":"basic",
      "conditions":[{"type":"variable_if","name":"DL","value":1},
        {"type":"variable_unless","name":"shifted","value":1},
        {"input_sources":[{"language":"ja"}],"type":"input_source_if"},
      {"input_sources":[{"input_mode_id":"Roman$"}],"type":"input_source_unless"}],
      "from":{"key_code":"x"},
      "to":[{"key_code":"b"},{"key_code":"i","repeat":false}
      ]
    },
    {"description":"[右濁] は → ば","type":"basic",
      "conditions":[{"type":"variable_if","name":"DL","value":1},
        {"type":"variable_unless","name":"shifted","value":1},
        {"input_sources":[{"language":"ja"}],"type":"input_source_if"},
      {"input_sources":[{"input_mode_id":"Roman$"}],"type":"input_source_unless"}],
      "from":{"key_code":"c"},
      "to":[{"key_code":"b"},{"key_code":"a","repeat":false}
      ]
    },
    {"description":"[右濁] こ → ご","type":"basic",
      "conditions":[{"type":"variable_if","name":"DL","value":1},
        {"type":"variable_unless","name":"shifted","value":1},
        {"input_sources":[{"language":"ja"}],"type":"input_source_if"},
      {"input_sources":[{"input_mode_id":"Roman$"}],"type":"input_source_unless"}],
      "from":{"key_code":"v"},
      "to":[{"key_code":"g"},{"key_code":"o","repeat":false}
      ]
    },
    {"description":"[右濁] そ → ぞ","type":"basic",
      "conditions":[{"type":"variable_if","name":"DL","value":1},
        {"type":"variable_unless","name":"shifted","value":1},
        {"input_sources":[{"language":"ja"}],"type":"input_source_if"},
      {"input_sources":[{"input_mode_id":"Roman$"}],"type":"input_source_unless"}],
      "from":{"key_code":"b"},
      "to":[{"key_code":"z"},{"key_code":"o","repeat":false}
      ]
    },
    {"description":"[左半] へ → ぺ","type":"basic",
      "conditions":[{"type":"variable_if","name":"HR","value":1},
        {"type":"variable_unless","name":"shifted","value":1},
        {"input_sources":[{"language":"ja"}],"type":"input_source_if"},
      {"input_sources":[{"input_mode_id":"Roman$"}],"type":"input_source_unless"}],
      "from":{"key_code":"p"},
      "to":[{"key_code":"p"},{"key_code":"e","repeat":false}
      ]
    },
    {"description":"[右半] ほ → ぽ","type":"basic",
      "conditions":[{"type":"variable_if","name":"HL","value":1},
        {"type":"variable_unless","name":"shifted","value":1},
        {"input_sources":[{"language":"ja"}],"type":"input_source_if"},
      {"input_sources":[{"input_mode_id":"Roman$"}],"type":"input_source_unless"}],
      "from":{"key_code":"z"},
      "to":[{"key_code":"p"},{"key_code":"o","repeat":false}
      ]
    },
    {"description":"[右半] ひ → ぴ","type":"basic",
      "conditions":[{"type":"variable_if","name":"HL","value":1},
        {"type":"variable_unless","name":"shifted","value":1},
        {"input_sources":[{"language":"ja"}],"type":"input_source_if"},
      {"input_sources":[{"input_mode_id":"Roman$"}],"type":"input_source_unless"}],
      "from":{"key_code":"x"},
      "to":[{"key_code":"p"},{"key_code":"i","repeat":false}
      ]
    },
    {"description":"[右半] は → ぱ","type":"basic",
      "conditions":[{"type":"variable_if","name":"HL","value":1},
        {"type":"variable_unless","name":"shifted","value":1},
        {"input_sources":[{"language":"ja"}],"type":"input_source_if"},
      {"input_sources":[{"input_mode_id":"Roman$"}],"type":"input_source_unless"}],
      "from":{"key_code":"c"},
      "to":[{"key_code":"p"},{"key_code":"a","repeat":false}
      ]
    },
    {"description":"[小] や → (ゃ)","type":"basic",
      "conditions":[{"type":"variable_if","name":"KO","value":1},
        {"input_sources":[{"language":"ja"}],"type":"input_source_if"},
      {"input_sources":[{"input_mode_id":"Roman$"}],"type":"input_source_unless"}],
      "from":{"key_code":"h"},
      "to":[{"key_code":"x"},{"key_code":"y"},{"key_code":"a","repeat":false}
      ]
    },
    {"description":"[小] ゆ → (ゅ)","type":"basic",
      "conditions":[{"type":"variable_if","name":"KO","value":1},
        {"input_sources":[{"language":"ja"}],"type":"input_source_if"},
      {"input_sources":[{"input_mode_id":"Roman$"}],"type":"input_source_unless"}],
      "from":{"key_code":"p"},
      "to":[{"key_code":"x"},{"key_code":"y"},{"key_code":"u","repeat":false}
      ]
    },
    {"description":"[小] よ → (ょ)","type":"basic",
      "conditions":[{"type":"variable_if","name":"KO","value":1},
        {"input_sources":[{"language":"ja"}],"type":"input_source_if"},
      {"input_sources":[{"input_mode_id":"Roman$"}],"type":"input_source_unless"}],
      "from":{"key_code":"i"},
      "to":[{"key_code":"x"},{"key_code":"y"},{"key_code":"o","repeat":false}
      ]
    },
    {"description":"[小] あ → (ぁ)","type":"basic",
      "conditions":[{"type":"variable_if","name":"KO","value":1},
        {"input_sources":[{"language":"ja"}],"type":"input_source_if"},
      {"input_sources":[{"input_mode_id":"Roman$"}],"type":"input_source_unless"}],
      "from":{"key_code":"j"},
      "to":[{"key_code":"x"},{"key_code":"a","repeat":false}
      ]
    },
    {"description":"[小] い → (ぃ)","type":"basic",
      "conditions":[{"type":"variable_if","name":"KO","value":1},
        {"input_sources":[{"language":"ja"}],"type":"input_source_if"},
      {"input_sources":[{"input_mode_id":"Roman$"}],"type":"input_source_unless"}],
      "from":{"key_code":"k"},
      "to":[{"key_code":"x"},{"key_code":"i","repeat":false}
      ]
    },
    {"description":"[Sp, 小] う → (ゎ)","type":"basic",
      "conditions":[{"type":"variable_if","name":"KO","value":1},
        {"type":"variable_if","name":"shifted","value":1},
        {"input_sources":[{"language":"ja"}],"type":"input_source_if"},
      {"input_sources":[{"input_mode_id":"Roman$"}],"type":"input_source_unless"}],
      "from":{"key_code":"l"},
      "to":[{"key_code":"x"},{"key_code":"w"},{"key_code":"a","repeat":false}
      ]
    },
    {"description":"[小] う → (ぅ)","type":"basic",
      "conditions":[{"type":"variable_if","name":"KO","value":1},
        {"input_sources":[{"language":"ja"}],"type":"input_source_if"},
      {"input_sources":[{"input_mode_id":"Roman$"}],"type":"input_source_unless"}],
      "from":{"key_code":"l"},
      "to":[{"key_code":"x"},{"key_code":"u","repeat":false}
      ]
    },
    {"description":"[小] え → (ぇ)","type":"basic",
      "conditions":[{"type":"variable_if","name":"KO","value":1},
        {"input_sources":[{"language":"ja"}],"type":"input_source_if"},
      {"input_sources":[{"input_mode_id":"Roman$"}],"type":"input_source_unless"}],
      "from":{"key_code":"o"},
      "to":[{"key_code":"x"},{"key_code":"e","repeat":false}
      ]
    },
    {"description":"[小] お → (ぉ)","type":"basic",
      "conditions":[{"type":"variable_if","name":"KO","value":1},
        {"input_sources":[{"language":"ja"}],"type":"input_source_if"},
      {"input_sources":[{"input_mode_id":"Roman$"}],"type":"input_source_unless"}],
      "from":{"key_code":"n"},
      "to":[{"key_code":"x"},{"key_code":"o","repeat":false}
      ]
    },
    {"description":"[こ] な → 行送り","type":"basic",
      "conditions":[{"type":"variable_if","name":"HR","value":1},
        {"input_sources":[{"language":"ja"}],"type":"input_source_if"},
      {"input_sources":[{"input_mode_id":"Roman$"}],"type":"input_source_unless"}],
      "from":{"key_code":"m"},
      "to":[{"key_code":"return_or_enter","repeat":false}
      ]
    },
    {"description":"[な] こ → 行送り","type":"basic",
      "conditions":[{"type":"variable_if","name":"HL","value":1},
        {"input_sources":[{"language":"ja"}],"type":"input_source_if"},
      {"input_sources":[{"input_mode_id":"Roman$"}],"type":"input_source_unless"}],
      "from":{"key_code":"v"},
    ...
    {"description":"[Sp] わ","type":"basic",
      ...
      {"input_sources":[{"input_mode_id":"Roman$"}],"type":"input_source_unless"}],
      "from":{"key_code":"period"},
      "to":[{"key_code":"w"},{"key_code":"a","repeat":false}
      ]
    },
    
    {"description":"ヴ","type":"basic",
      "conditions":[
        {"input_sources":[{"language":"ja"}],"type":"input_source_if"},
        {"input_sources":[{"input_mode_id":"Roman$"}],"type":"input_source_unless"}
      ],
      "from":{"key_code":"q"},
      "to":[
        {"key_code":"v"},{"key_code":"u","repeat":false}
      ]
    },
